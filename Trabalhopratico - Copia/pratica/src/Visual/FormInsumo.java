...
public class FormInsumo extends javax.swing.JDialog {
    DAOInsumo daoInsumo = new DAOInsumo();
    
    public void atualizaTabela(){
        listObjetos.clear();
        listObjetos.addAll(daoInsumo.getLista());
    ...
    private void trataEdicao(boolean editando){
        ...
        txtIdInsumo.setEditable(!editando);
    ...
    public boolean validaCampos(){
        if(!(txtNome.getText().length() > 0)){
            JOptionPane.showMessageDialog(null, "Digite o nome do Insumo!");
            txtNome.requestFocus();
            return false;
        }
        
        if(!(txtPreco.getText().length() > 0)){
            JOptionPane.showMessageDialog(null, "Digite o preço do Insumo!");
    ...
    public FormInsumo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        atualizaTabela();
        trataEdicao(false);
    ...
    private void initComponents() {
        ...
        listObjetos = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Insumo>())
        ;
        ...
        btnFornece = new javax.swing.JButton();
        ...
        lbIdProduto.setText("ID Insumo");

        lbNome.setText("Nome");

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblObjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.id_insumo}"), txtIdInsumo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        btnFornece.setText("Fornece");
        btnFornece.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnForneceActionPerformed(evt);
            }
        });
                ...
                .addGroup(abaDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(abaDadosLayout.createSequentialGroup()
                        ...
                        .addGroup(abaDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtIdInsumo, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                            .addComponent(txtNome)
                            .addComponent(txtPreco)))
                    .addGroup(abaDadosLayout.createSequentialGroup()
                        .addGap(236, 236, 236)
                        .addComponent(btnFornece)))
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        listObjetos.add((Insumo) new Insumo());
        int linha = listObjetos.size() - 1;
        tblObjetos.setRowSelectionInterval(linha, linha);
        trataEdicao(true);
        btnFornece.setEnabled(false);
        txtNome.requestFocus();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if(validaCampos()){
            ...
            Insumo obj = listObjetos.get(linhaSelecionada);
            daoInsumo.salvar(obj);
            trataEdicao(false);
            btnFornece.setVisible(true);
            atualizaTabela();
        }
    ...
    private void btnForneceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnForneceActionPerformed
        FormFornece form = new FormFornece(null, true);
    ...
    }//GEN-LAST:event_btnForneceActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormInsumo dialog = new FormInsumo(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton btnFornece;
    ...
    private java.util.List<Insumo> listObjetos;
